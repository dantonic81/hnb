...
def log_invalid_product(connection: Any, product: Dict[str, Any], error_message: str, date: str, hour: str) -> None:
    """
...
def transform_and_validate_products(connection: Any, products_data: List[Dict[str, Any]], date: str, hour: str) -> List[Dict[str, Any]]:
    """
...
def log_processed_products(connection: Any, date: str, hour: str, skus: List[str], names: List[str], prices: List[float], categories: List[str], popularities: List[int]) -> None:
    """
